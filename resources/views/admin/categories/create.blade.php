...
<div class="flex justify-between items-center mb-6">
    <div class="flex items-center gap-3">
        ...
        <h2 class="font-heading font-semibold text-2xl text-eva-heading">Yeni Kategori</h2>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              placeholder="Kategori açıklamasını girin">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-eva-silver/50 rounded-lg p-6 text-center hover:border-eva-gold transition-colors">
                        ...
                        <label for="image" class="cursor-pointer">
                            ...
                            <p class="text-sm text-eva-muted">Resim yüklemek için tıklayın</p>
