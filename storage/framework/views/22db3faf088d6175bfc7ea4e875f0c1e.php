<?php $__env->startSection('title', 'Ana Sayfa - EvaHome'); ?>
...
<section id="most-liked" class="py-24 bg-gradient-to-b from-gray-50 to-white">
    <div class="container">
        ...
        <?php if(isset($mostLikedProducts) && count($mostLikedProducts) > 0): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-4">
            <?php $__currentLoopData = $mostLikedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col">
                <div class="relative aspect-square bg-gray-100 overflow-hidden flex-shrink-0 group">
                    <?php if($product->image): ?>
                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover group-hover:scale-102 transition-transform duration-500">
                    <?php else: ?>
                    ...
                    <?php if($product->energyCollection): ?>
                        <div class="absolute top-4 left-4 w-8 h-8 rounded-full shadow-lg border-2 border-white" style="background-color: <?php echo e($product->energyCollection->color_code); ?>;"></div>
                    <?php endif; ?>
                    ...
                    <!-- Favorite Badge -->
                    <div id="favorite-badge-<?php echo e($product->id); ?>" class="absolute top-3 right-3 hidden">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <h3 class="text-lg font-bold mb-1.5 text-gray-800 line-clamp-2"><?php echo e($product->name); ?></h3>
                    
                    <p class="text-gray-600 text-sm mb-2 line-clamp-2"><?php echo e($product->short_description); ?></p>
                    ...
                    <?php if($product->rating > 0): ?>
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-sm text-gray-600 ml-2">(<?php echo e($product->rating_count); ?>)</span>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div>
                            <?php if($product->hasDiscount()): ?>
                                <span class="text-xl font-bold text-indigo-600"><?php echo e(number_format($product->finalPrice(), 2)); ?> ₺</span>
                                <span class="text-sm text-gray-400 line-through ml-2"><?php echo e(number_format($product->price, 2)); ?> ₺</span>
                            <?php else: ?>
                    ...
                    <div class="flex gap-2">
                        <button onclick="addToCartFromHome(<?php echo e($product->id); ?>)" 
                        ...
                        <button onclick="toggleFavorite(<?php echo e($product->id); ?>)" 
                                id="favorite-btn-<?php echo e($product->id); ?>"
                            ...
                            <i id="favorite-icon-<?php echo e($product->id); ?>" class="far fa-heart mr-1"></i>
                            Favorilere
                        </button>
                    </div>
                </div>
        ...
        <div class="text-center mt-16">
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-secondary text-lg px-12 py-4">
...
<?php if(isset($energyCollections) && count($energyCollections) > 0): ?>
    ...
    <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-4">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div style="background-color: <?php echo e($collection->color_code); ?>; height: 250px;" class="flex items-center justify-center relative overflow-hidden group">
                    <?php if($collection->image): ?>
                        <img src="<?php echo e(asset('storage/' . $collection->image)); ?>" alt="<?php echo e($collection->name); ?>" class="max-w-full max-h-full object-contain group-hover:scale-110 transition-transform duration-500">
                    <?php else: ?>
                        <span class="text-white text-4xl font-bold"><?php echo e($collection->name); ?></span>
                    <?php endif; ?>
                ...
                <div class="p-6">
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e($collection->name); ?></h3>
                    <p class="text-gray-600 mb-4 line-clamp-3"><?php echo e($collection->description); ?></p>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <span class="text-sm text-gray-500">Renk:</span>
                            <div class="w-6 h-6 rounded-full border-2 border-gray-300" style="background-color: <?php echo e($collection->color_code); ?>;"></div>
                        </div>
                        <a href="<?php echo e(route('collections.show', $collection->slug)); ?>" class="text-primary hover:text-primary-dark font-semibold flex items-center">
                            Keşfet 
        ...
        <div class="text-center mt-16">
            <a href="<?php echo e(route('collections.index')); ?>" class="btn btn-secondary text-lg px-12 py-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\evahome\resources\views/home.blade.php ENDPATH**/ ?>